...
<script defer src="${contextPath }/js/packinglist/loadListForm.js?ver=1"></script>
</head>
<body>
	<div class="pop_wrapper">
		<div class="pop_header row_a">
			...
			<div class="manage_btn_wrap">
				<a href="${contextPath }/mypage/mylist" target="_blank" class="manage_btn" id="goMyListBtn"> 리스트 관리 <i
